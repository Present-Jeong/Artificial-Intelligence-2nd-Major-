...
data_dir = "/data2/workspace/present/Project3/VOCtrainval_11-May-2012/VOCdevkit/VOC2012"
resize_size = 256
...
##### fill in here #####
model.load_state_dict(torch.load('/data2/workspace/present/Project3/trained_model/UNet_trained_model.pth'))
#model.load_state_dict(torch.load('/data2/workspace/present/Project3/trained_model/resnet_encoder_unet.pth'))
