...
class UNetWithResnet50Encoder(nn.Module):
    def __init__(self, n_classes=22):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=7,padding=3,stride=2), # Code overlaps with previous assignments
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True)#,
        )
        ...
        self.layer3 = nn.Sequential(
            ...
            ResidualBlock(512,128,512),
            ResidualBlock(512,128,512) # Code overlaps with previous assignments
        )
